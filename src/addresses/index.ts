...
export const addresses: { [chainId: number]: Address } = {
  ...
  100: {
    registry: '0xf5eB8A8Fb280282db61F6e9464D4A4dEe22365cD',
    [constants.bridges.Hop]: '0xD5B2E9e3b2451C6f1Ce586c52325842d025e7609',
    routeIds: {
      [constants.bridges.Hop]: 1,
    },
    chainInfo: {
  ...
  137: {
    registry: '0xf5eB8A8Fb280282db61F6e9464D4A4dEe22365cD',
    [constants.bridges.Hop]: '0x701072fD9b1Aaf2f30ACF5778b9986CeeFc0c6e1',
    [constants.bridges.AnySwapRouterV4]:
      '0x129DE364b6fB73ea15CCF002Bf77fF3123053964',
    [constants.bridges.Hyphen]: '0xC8f65C528aB5c3870779F6b4C28b45DcF9b0BBE4',
    [constants.middleware.OneInch]:
      '0xa39B189Eac25Ad9DE6F6492BB6681105f09257F3',
    routeIds: {
      [constants.bridges.Hop]: 1,
